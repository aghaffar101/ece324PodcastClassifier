...
class CNNClassifier(nn.Module):
    ...
    def __init__(self, height, width, channels, numClasses=10):
        ...
        # need a softmax in the output though:
        self.probabilities = torch.softmax(numClasses, dim=1)
    ...
    def forward(self, x):
        ...
        return self.probabilities(x) # softmax output of probalities of each podcast title
