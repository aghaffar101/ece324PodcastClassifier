...
class CNNClassifier(nn.Module):
    ...
    def __init__(self, height, width, channels, kernelSize=3, numClasses=10):
        ...
        self.conv2 = nn.Conv2d(32, 16, kernelSize)
        
        self.pool1 = nn.MaxPool2d(2, 2)
        
        self.conv3 = nn.Conv2d(channels, 6, kernelSize)
        self.conv4 = nn.Conv2d(6, 16, kernelSize)
        
        self.pool2 = nn.MaxPool2d(2, 2)

        self.conv5 = nn.Conv2d(channels, 6, kernelSize)
        self.conv6 = nn.Conv2d(6, 16, kernelSize)
