...
if __name__ == "__main__":
    ...
    for epoch in range(num_epochs):
        ...
        # Save model weights
        with open(os.path.join(model_save_path, f"model_epoch_{epoch+1}.pkl"), 'wb') as f:
    ...
    # load the saved weights - from a specific epoch # (in this case it is num_epochs = 5)
    with open(f"model_weights/model_epoch_{num_epochs}.pkl", 'rb') as f:
