...
def train_model(model, dataloaders, criterion, optimizer, num_epochs=25, is_inception=False):
    ...
    return model, train_acc_history, val_acc_history, train_loss_history, valid_loss_history
...
# Train and evaluate
    ...
    plt.plot(epochs_for_plot, valid_losses, label="Valid")
    plt.xlabel("Epoch")
    plt.ylabel("Loss")
    plt.legend(loc='best')
    plt.show()
    ...
    plt.plot(epochs_for_plot, valid_accs, label="Valid")
    plt.xlabel("Epoch")
    plt.ylabel("Accuracy")
    plt.legend(loc='best')
    plt.show()
